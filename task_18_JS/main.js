let heroes_block = document.querySelector('.heroes');
let stars = [];
for (let i = 0; i < 10; i++)
    stars.push(-1)

const showInfo = () => {
    heroes_block.innerHTML = '';
    ...
    fetch('data.json')
        ...
        .then(data => data.forEach((element, index) => {
            heroes_block.innerHTML += showInfoHero(element, index);
            starFill(index, stars[index]);
        }));
}

const showInfoHero = (item, index) => {
    return `
<div class='hero'>
    <h2>${item.name}</h2>
    <p>Вселенная: ${item.universe}</p>
    <p>Альтерэго: ${item.alterego}</p>
    <p>Род деятельности: ${item.occupation}</p>
    <p>Друзья: ${item.friends}</p>
    <p>Суперсила: ${item.superpowers}</p>
    <img class='hero_img' src='${item.url}' alt='hero'>
    <p class='like' id='${index}' >        
        <svg onclick='starClick(${index}, 0)' class='like_img' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	   xml:space="preserve">
<g>
...
<svg  class='like_img' onclick='starClick(${index}, 1)' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	   xml:space="preserve">
<g>
	<path d="M36.042,13.909c-0.123-0.377-0.456-0.646-0.85-0.688l-11.549-1.172L18.96,1.43c-0.16-0.36-0.519-0.596-0.915-0.596
		s-0.755,0.234-0.915,0.598L12.446,12.05L0.899,13.221c-0.394,0.04-0.728,0.312-0.85,0.688c-0.123,0.377-0.011,0.791,0.285,1.055
...
<svg  class='like_img' onclick='starClick(${index}, 2)' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	   xml:space="preserve">
<g>
	<path d="M36.042,13.909c-0.123-0.377-0.456-0.646-0.85-0.688l-11.549-1.172L18.96,1.43c-0.16-0.36-0.519-0.596-0.915-0.596
		s-0.755,0.234-0.915,0.598L12.446,12.05L0.899,13.221c-0.394,0.04-0.728,0.312-0.85,0.688c-0.123,0.377-0.011,0.791,0.285,1.055
...
<svg  class='like_img' onclick='starClick(${index}, 3)' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	   xml:space="preserve">
<g>
	<path d="M36.042,13.909c-0.123-0.377-0.456-0.646-0.85-0.688l-11.549-1.172L18.96,1.43c-0.16-0.36-0.519-0.596-0.915-0.596
		s-0.755,0.234-0.915,0.598L12.446,12.05L0.899,13.221c-0.394,0.04-0.728,0.312-0.85,0.688c-0.123,0.377-0.011,0.791,0.285,1.055
...
<svg  class='like_img' onclick='starClick(${index}, 4)' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	   xml:space="preserve">
<g>
	<path d="M36.042,13.909c-0.123-0.377-0.456-0.646-0.85-0.688l-11.549-1.172L18.96,1.43c-0.16-0.36-0.519-0.596-0.915-0.596
		s-0.755,0.234-0.915,0.598L12.446,12.05L0.899,13.221c-0.394,0.04-0.728,0.312-0.85,0.688c-0.123,0.377-0.011,0.791,0.285,1.055
...
const starFill = (index, number) => {
    const p = document.querySelectorAll('.like')[index];
    for (let i = 0; i < 5; i++) {
        p.children[i].style.fill = 'black';
    }
    for (let i = 0; i <= number; i++) {
        p.children[i].style.fill = 'gold';
    }
}
